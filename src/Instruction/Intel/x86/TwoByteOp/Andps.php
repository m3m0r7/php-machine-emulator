...
/**
 * ANDPS/ANDPD (0x0F 0x54 /r, 0x66 0x0F 0x54 /r)
 * Bitwise AND of packed values in XMM registers.
 */
class Andps implements InstructionInterface
{
    use Instructable;

    public function opcodes(): array
    {
        return $this->applyPrefixes([[0x0F, 0x54]]);
    }
