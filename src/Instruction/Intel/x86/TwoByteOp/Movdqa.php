...
/**
 * MOVDQA (0x66 0x0F 0x6F /r, 0x66 0x0F 0x7F /r)
 * Move aligned packed integer values.
 */
class Movdqa implements InstructionInterface
{
    use Instructable;
    ...
    public function opcodes(): array
    {
        return $this->applyPrefixes(
            [
                [0x66, 0x0F, 0x6F], // xmm, xmm/m128
                [0x66, 0x0F, 0x7F], // xmm/m128, xmm
            ],
    ...
    {
        if (($address & 0xF) !== 0) {
            throw new FaultException(0x0D, 0, sprintf('MOVDQA: unaligned memory address 0x%X', $address));
        }
    }
}
