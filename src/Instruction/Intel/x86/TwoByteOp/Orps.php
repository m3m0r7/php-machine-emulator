...
/**
 * ORPS/ORPD (0x0F 0x56 /r, 0x66 0x0F 0x56 /r)
 * Bitwise OR of packed values in XMM registers.
 */
class Orps implements InstructionInterface
{
    use Instructable;

    public function opcodes(): array
    {
        return $this->applyPrefixes([[0x0F, 0x56]]);
    }
